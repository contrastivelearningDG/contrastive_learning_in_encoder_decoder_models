...
model = T5ForConditionalGeneration.from_pretrained('./dgen_models_train/t5_base_cl_triplet_002').to(device)
tokenizer = T5Tokenizer.from_pretrained('./dgen_models_train/t5_base_cl_triplet_002')
test_data = load_data('./data/sciq_test_1.json')
...
with open('./cross_domain/sciq_test_mcq_cl_triple_002.json', 'w') as f:
    json.dump(results, f, indent=2)
print("Generated distractors saved in 'sciq_test_mcq_cl_triple_002.json'")
